...
namespace Inevtory2.Controllers
{
    public class InventoriesController : Controller
    {
        ...
        {
            var mainInventory = db.MainInventory.Include(i => i.DEPARTMENT).Include(i => i.EQUIPMENT).Include(i => i.LOCATION).Include(i => i.MANUFACTURER).Include(i => i.MODEL).Include(i => i.STATUS);
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.EquipmentId = new SelectList(db.Equipment, "Id", "euipmentname");
        ...
        public ActionResult Create([Bind(Include = "InventoryId,EquipmentId,ManufacturerId,ModelId,SerialNo,DateOfPuchaseId,LocationId,StatusId,DepartmentId")] Inventory inventory)
        {
            ...
            ViewBag.EquipmentId = new SelectList(db.Equipment, "Id", "euipmentname", inventory.EquipmentId);
